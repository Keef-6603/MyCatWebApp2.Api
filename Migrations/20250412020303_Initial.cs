            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CatBoxId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CatBoxType = table.Column<string>(type: "TEXT", nullable: false),
                    CatBoxSize = table.Column<string>(type: "TEXT", nullable: false),
                    CFeatures = table.Column<string>(type: "TEXT", nullable: false),
